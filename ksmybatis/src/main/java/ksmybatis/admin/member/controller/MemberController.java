...
import ksmybatis.admin.common.servie.CommonService;
...
public class MemberController {
	...
	public String addMember(Member member, @RequestParam(required=false)List<String> memberTelNum) {
		
		log.info("회원 등록정보:{}",member);
		
		memberTelNum.forEach(telNo -> log.info("회원 등록정보:{}",telNo));
